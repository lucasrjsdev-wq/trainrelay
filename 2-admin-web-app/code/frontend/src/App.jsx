...
import PanelUsuariosPage from "./pages/PanelUsuariosPage";
  ...
  return (
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route exact path='/panel-usuarios' element={<ProtectedRoute><PanelUsuariosPage /></ProtectedRoute>} />
        <Route exact path='/usuarios/:id' element={<ProtectedRoute><UsuarioDetallePage /></ProtectedRoute>} />
        ...
        <Route exact path='/recuperar-contrasena' element={<ForgotPasswordPage />} />
        <Route exact path='/nueva-contrasena' element={<ResetPasswordPage />} />
        <Route exact path='/registrarse' element={<RegistroPage />} />
