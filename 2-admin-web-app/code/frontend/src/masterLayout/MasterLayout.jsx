    ...
    <section className={mobileMenu ? "overlay active" : "overlay "}>
      ...
      >
        ...
        <div className='d-flex justify-content-center'>
          <Link to='/' className='sidebar-logo'>
            <img
              ...
              style={{ height: '40px', width: 'auto', maxWidth: '168px' }}
            />
            <img
              src='assets/images/logo.png'
              alt='TrainRelay'
        ...
        <div className='sidebar-menu-area'>
          <ul className='sidebar-menu' id='sidebar-menu'>
            {/* TrainRelay */}
            <li className='sidebar-menu-group-title'>TrainRelay</li>
            <li>
              <NavLink
                to='/'
                end
      ...
      >
        ...
        <footer className='d-footer'>
          <div className='row align-items-center justify-content-between'>
            <div className='col-auto'>
              <p className='mb-0'>© {new Date().getFullYear()} Train Relay. All Rights Reserved.</p>
            </div>
            <div className='col-auto'>
              <p className='mb-0'>
                Made by <a href='https://raisepatagonia.com.ar/' target='_blank' rel='noreferrer' className='text-primary-600 hover-text-primary'>raise patagonia</a>
              </p>
            </div>
          </div>
        </footer>
